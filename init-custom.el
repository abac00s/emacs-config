(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (solarized-theme geiser aggressive-indent evil-cleverparens lispy rainbow-delimiters magit ace-jump-mode auto-complete material-theme which-key general use-package evil))))
(custom-set-faces
